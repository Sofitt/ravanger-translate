...
class LLMTranslator:
    ...
    # ЗАКОММЕНТИРОВАНО: Правила перевода зашиты в модель
    # Системный промпт удален - правила встроены в fine-tuned модель
    ...
    # ЗАКОММЕНТИРОВАНО: Самопроверка не используется
    # Функции _create_validation_prompt и _verify_translation удалены
